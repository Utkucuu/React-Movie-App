...
function PageNav() {
  ...
  return (
    <div className="my-5 flex items-center justify-between divide-x rounded-xl bg-gradient-to-b from-cyan-400 to-sky-900 pb-1 dark:from-slate-900 dark:to-sky-900 md:p-4 lg:my-10">
