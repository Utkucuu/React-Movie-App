...
function PageNav() {
  ...
  return (
    <div className="my-5 flex items-center justify-between divide-x rounded-xl bg-gradient-to-b from-cyan-400 to-sky-900 py-1 dark:from-slate-900 dark:to-sky-900 xs:p-2 md:p-4 lg:my-10">
